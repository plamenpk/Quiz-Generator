...
const Sidebar: React.FC = () => {
  ...
  return (
    <>
      <div id="docs-sidebar" className="flex flex-col items-center pt-20 w-26 h-screen bg-white border-r rtl:border-l rtl:border-r-0 dark:bg-gray-900 dark:border-gray-700">
      ...
      {/* <aside className="flex flex-col items-center pt-20 w-26 h-screen bg-white border-r rtl:border-l rtl:border-r-0 dark:bg-gray-900 dark:border-gray-700">
        <nav className="flex flex-col flex-1 space-y-1">
          <Link to="/home" className="p-1.5 w-auto focus:outline-nones transition-colors duration-200 dark:text-gray-200 dark:hover:bg-gray-800 hover:bg-gray-200">Home</Link>
          <Link to="/login" className="p-1.5 w-auto focus:outline-nones transition-colors duration-200 dark:text-gray-200 dark:hover:bg-gray-800 hover:bg-gray-200">Log In</Link>
          <Link to="/register" className="p-1.5 w-auto focus:outline-nones transition-colors duration-200 dark:text-gray-200 dark:hover:bg-gray-800 hover:bg-gray-200">Register</Link>
          <Link to="/"
            className="p-1.5 w-auto focus:outline-nones transition-colors duration-200 dark:text-gray-200 dark:hover:bg-gray-800 hover:bg-gray-200"
            onClick={onLogout}
          >
            Logout
          </Link>
